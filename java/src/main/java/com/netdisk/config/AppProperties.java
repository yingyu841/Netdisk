...
public class AppProperties {
    ...
    public static class ResponseCache {
        ...
        public long getIndexTtlSeconds() {
            return indexTtlSeconds;
        }

        public void setIndexTtlSeconds(long indexTtlSeconds) {
        ...
        public List<String> getIncludePathPrefixes() {
            return includePathPrefixes;
        }
        ...
        public List<String> getExcludePathSuffixes() {
            return excludePathSuffixes;
        }
        ...
        public List<String> getExcludeExactPaths() {
            return excludeExactPaths;
        }
    ...
    public static class ChatMq {
        ...
        public String getReadBatchQueue() {
            return readBatchQueue;
        }

        public void setReadBatchQueue(String readBatchQueue) {
            this.readBatchQueue = readBatchQueue;
        }

        public String getReadBatchRoutingKey() {
            return readBatchRoutingKey;
        }

        public void setReadBatchRoutingKey(String readBatchRoutingKey) {
            this.readBatchRoutingKey = readBatchRoutingKey;
        }
        ...
        public int getOutboxPollMs() {
            return outboxPollMs;
        }

        public void setOutboxPollMs(int outboxPollMs) {
            this.outboxPollMs = outboxPollMs;
        }

        public int getOutboxRetryDelaySeconds() {
            return outboxRetryDelaySeconds;
        }

        public void setOutboxRetryDelaySeconds(int outboxRetryDelaySeconds) {
            this.outboxRetryDelaySeconds = outboxRetryDelaySeconds;
        }

        public int getOutboxCleanupMs() {
            return outboxCleanupMs;
        }

        public void setOutboxCleanupMs(int outboxCleanupMs) {
            this.outboxCleanupMs = outboxCleanupMs;
        }

        public int getOutboxSentRetentionDays() {
            return outboxSentRetentionDays;
        }

        public void setOutboxSentRetentionDays(int outboxSentRetentionDays) {
            this.outboxSentRetentionDays = outboxSentRetentionDays;
        }

        public int getOutboxMonitorMs() {
            return outboxMonitorMs;
        }

        public void setOutboxMonitorMs(int outboxMonitorMs) {
            this.outboxMonitorMs = outboxMonitorMs;
        }

        public int getOutboxWarnPendingThreshold() {
            return outboxWarnPendingThreshold;
        }

        public void setOutboxWarnPendingThreshold(int outboxWarnPendingThreshold) {
            this.outboxWarnPendingThreshold = outboxWarnPendingThreshold;
        }

        public int getOutboxWarnDeadThreshold() {
            return outboxWarnDeadThreshold;
        }

        public void setOutboxWarnDeadThreshold(int outboxWarnDeadThreshold) {
            this.outboxWarnDeadThreshold = outboxWarnDeadThreshold;
        }

        public int getConsumerLogCleanupMs() {
            return consumerLogCleanupMs;
        }

        public void setConsumerLogCleanupMs(int consumerLogCleanupMs) {
            this.consumerLogCleanupMs = consumerLogCleanupMs;
        }

        public int getConsumerLogRetentionDays() {
            return consumerLogRetentionDays;
        }

        public void setConsumerLogRetentionDays(int consumerLogRetentionDays) {
            this.consumerLogRetentionDays = consumerLogRetentionDays;
        }
    }
    ...
    public static class Aliyun {
        ...
        public String getDmRegion() {
            return dmRegion;
        }

        public void setDmRegion(String dmRegion) {
            this.dmRegion = dmRegion;
        }

        public String getDmFromAddress() {
            return dmFromAddress;
        }

        public void setDmFromAddress(String dmFromAddress) {
            this.dmFromAddress = dmFromAddress;
        }

        public String getDmFromAlias() {
            return dmFromAlias;
        }

        public void setDmFromAlias(String dmFromAlias) {
            this.dmFromAlias = dmFromAlias;
        }

        public String getDmReplyToAddress() {
            return dmReplyToAddress;
        }

        public void setDmReplyToAddress(String dmReplyToAddress) {
            this.dmReplyToAddress = dmReplyToAddress;
        }
    }
    ...
    public long getVerificationCodeSeconds() {
        return verificationCodeSeconds;
    }

    public void setVerificationCodeSeconds(long verificationCodeSeconds) {
        this.verificationCodeSeconds = verificationCodeSeconds;
    }

    public long getVerificationSendIntervalSeconds() {
        return verificationSendIntervalSeconds;
    }

    public void setVerificationSendIntervalSeconds(long verificationSendIntervalSeconds) {
        this.verificationSendIntervalSeconds = verificationSendIntervalSeconds;
    }

    public long getFileAccessTtlSeconds() {
        return fileAccessTtlSeconds;
    }

    public void setFileAccessTtlSeconds(long fileAccessTtlSeconds) {
        this.fileAccessTtlSeconds = fileAccessTtlSeconds;
    }

    public String getFileAccessSecret() {
        return fileAccessSecret;
    }

    public void setFileAccessSecret(String fileAccessSecret) {
        this.fileAccessSecret = fileAccessSecret;
    }

    public boolean isSlowApiEnabled() {
        return slowApiEnabled;
    }

    public void setSlowApiEnabled(boolean slowApiEnabled) {
        this.slowApiEnabled = slowApiEnabled;
    }
